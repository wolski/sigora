...
#' @section Motivation:
#'
#' A thought experiment Imagine you randomly selected
...
#'
#' @section Available Pathway-GPS repositories in SIGORA:
#'
...
#'
#' @section Creating a GPS repository:
#'
...
#'
#' @section Analysing your data To preform Signature Overrepresentation:
#'
...
#'
#' @section Gene identifier mapping Mappings:
#'
#' between \emph{ENSEMBL}-IDS,\emph{ENTREZ}-IDS and Gene-Symbols are performed
#' automatically.
#'
